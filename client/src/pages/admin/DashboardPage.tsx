                                    ...
                                    <tbody>
                                        {recentActivities.map((record) => (
                                            <tr key={record.id} className="border-b border-gray-50 hover:bg-gray-50/50">
                                                ...
                                                <td className="px-4 py-3 text-[10px] font-bold text-gray-700 max-w-[120px]">
                                                ...
                                                <td className="px-4 py-3 text-xs text-gray-500 italic max-w-[150px] truncate" title={record.notes || "-"}>
                                                    {record.notes ? record.notes.replace(/\[DURATION:\d+\]\s*/, '') : "-"}
                                                </td>
                                            </tr>
                                        ))}
